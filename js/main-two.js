$(function() {
  ...
  var title = $("#main-two .main-text .text-contain h2");
  var body = $("#main-two .main-text .text-contain");
  ...
  var bodies = [
    ...
    "<h2>Quali-Fi (BETA)</h2><p>Employers and applicants in technical fields spend countless hours weeding through resumes and job postings to find the right fit for the position. But what if they didn't have to?</p><p>Quali-Fi matches employers with applicants (and vice versa) who meet the minimum technical qualifications associated with the job, crunching data on the available pool of active job seekers so that employers can spend less time looking and more time working.</p><p>Quali-Fi is Angular in the front(end) and Rails in the back(end), but whatever end, it's made with love.</p>",
